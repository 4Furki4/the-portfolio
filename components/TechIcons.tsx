  ...
  return (
    <>
      <Image
        ...
        width={300}
        height={100}
        className="max-w-max w-full h-[40px] sm:h-[50px] mx-auto"
      />
      <Image
        alt="TS Icon"
        src={tsIcon}
        width={300}
        height={100}
        className="w-max-w w-full h-[40px] sm:h-[50px]"
      />
      <Image
        alt="Node.js Icon"
        src={nodejsIcon}
      ...
      <Image
        ...
        width={300}
        height={100}
        className="w-max-w w-full h-[40px] sm:h-[50px] dark:hidden"
      />
      <Image
        alt="MySQL Icon"
        src={mysqlDarkIcon}
        width={300}
        height={100}
        className="w-max-w w-full h-[40px] sm:h-[50px] hidden dark:block"
      />
      <Image
        alt="MongoDB Icon"
        src={mongodb}
